...
class ImportTemplateGeneratorTest extends TestCase
{
    ...
    {
        $importers = [
            'HugoSEIGLE\SymfonyImportExportBundle\Tests\Entity\TestEntity' => [
        ...
        $this->importer = new ImporterTemplate($importers, $this->translator, $this->methodToSnake);
    }

    public function testGetImportTemplateXlsx(): void
    {
        $response = $this->importer->getImportTemplate('HugoSEIGLE\SymfonyImportExportBundle\Tests\Entity\TestEntity', ImporterInterface::XLSX);
    ...
    {
        $response = $this->importer->getImportTemplate('HugoSEIGLE\SymfonyImportExportBundle\Tests\Entity\TestEntity', ImporterInterface::CSV);
        $this->assertInstanceOf(StreamedResponse::class, $response);
